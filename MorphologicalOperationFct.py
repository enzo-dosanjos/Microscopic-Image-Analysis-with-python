...
def erode(img, kernel, iteration):
    """
    verify for each pixel if every pixels around are white (for our chosen kernel). If it is the case, then the pixel is white else, the pixel is black. Hence, it extend the black color
